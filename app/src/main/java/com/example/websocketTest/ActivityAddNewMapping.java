            ...
            selectNumFingers.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for (int actionCoding = Controls.TAP; actionCoding <= Controls.MOVE_DOWN; actionCoding++) {
                        ...
                        Controls.TaskDetail duplicatedDetail = currentMapping.get(actionFingerCount + action);
                        if (duplicatedDetail != null) {
                            if (duplicatedDetail.getDescription().contains(getString(R.string.basicControl))) {
                                continue;
                            }
